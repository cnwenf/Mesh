...
const PER_FILE_DIRS = [
  ...
  // MES-79(search-command-palette):搜索/命令面板 + 审批入口 + 扁平迁移/工作区解析。
  'src/features/search/',
  'src/features/approvals/',
  'src/workspace/flatRoutes.tsx',
  'src/workspace/lastWorkspace.ts',
  'src/workspace/WorkspacePickerPage.tsx',
  'src/workspace/pages/settingsSubpages.tsx',
  'src/features/members/MemberDetailPage.tsx',
  'src/hooks/',
  'src/state/',
  'src/design/',
];
