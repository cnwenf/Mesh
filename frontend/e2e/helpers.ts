...
/**
 * mock 服务地址(默认契约端口 8901)。MESH_E2E_MOCK_PORT 同时驱动 Playwright
 * 拉起的 mock server、浏览器 API/WS 基址与本 helper，供同机多 run 安全隔离。
 */
export const MOCK_BASE = `http://127.0.0.1:${String(process.env.MESH_E2E_MOCK_PORT ?? '8901')}`;
