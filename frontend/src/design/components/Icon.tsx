...
export const ICON_PATHS: Readonly<Record<string, ReadonlyArray<string>>> = Object.freeze({
  ...
  sparkle: [
    'M12 3l2 5.5L19.5 10 14 12l-2 5.5L10 12 4.5 10 10 8.5 12 3z',
    'M19 15.5l.8 2.2 2.2.8-2.2.8-.8 2.2-.8-2.2-2.2-.8 2.2-.8.8-2.2z',
  ],
  user: ['M12 4a4 4 0 1 1 0 8 4 4 0 0 1 0-8z', 'M4 20.5c0-3.9 3.6-6.5 8-6.5s8 2.6 8 6.5'],
  // agent 统一轮廓(§7.2:不用随机 emoji)
  agent: [
    'M5.5 8.5h13V19a1 1 0 0 1-1 1h-11a1 1 0 0 1-1-1V8.5z',
    'M12 8.5V5',
    'M12 5a1.25 1.25 0 1 0-.01 0z',
    'M9.25 13.25h.01',
    'M14.75 13.25h.01',
    'M9 16.75h6',
  ],
  ...
  inbox: [
    ...
    'M5.5 5.5h13l3 8v5a1 1 0 0 1-1 1h-17a1 1 0 0 1-1-1v-5l3-8z',
  ],
  settings: [
  ...
  bell: [
    'M6 9.5a6 6 0 1 1 12 0c0 4.5 1.8 5.8 1.8 5.8H4.2S6 14 6 9.5z',
    'M10 19.5a2.2 2.2 0 0 0 4 0',
  ],
  external: [
    'M18 13.5V19a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1V7a1 1 0 0 1 1-1h5.5',
    'M14 4h6v6',
    'M10 14L20 4',
  ],
  ...
  trash: [
    ...
    'M6.5 7l1 13a1 1 0 0 0 1 .9h7a1 1 0 0 0 1-.9l1-13',
    'M10 11.5v5.5',
    'M14 11.5v5.5',
  ],
  archive: ['M3.5 4.5h17v4h-17z', 'M5.5 8.5V19a1 1 0 0 0 1 1h11a1 1 0 0 0 1-1V8.5', 'M10 12.5h4'],
  send: ['M21.5 2.5L11 13', 'M21.5 2.5l-6.8 19-3.7-8.5-8.5-3.7 19-6.8z'],
  calendar: [
    'M4 6a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v13a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6z',
    'M4 10.5h16',
    'M8.5 2.5v3',
    'M15.5 2.5v3',
  ],
  ...
  megaphone: [
    'M3 11 18 5v14L3 13z',
    'M3 11v2a2 2 0 0 0 2 2h1',
    'M7 15v4a2 2 0 0 0 2 2h1a1 1 0 0 0 1-1v-3',
    'M18 8a4 4 0 0 1 0 8',
  ],
  link: [
