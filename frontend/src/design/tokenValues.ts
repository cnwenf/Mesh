...
export const LIGHT_TOKEN_GROUPS: ReadonlyArray<TokenGroup> = [
  {
    ...
    tokens: {
      ...
      '--color-surface-subtle': 'oklch(96.7% 0.001 286.375)',
      '--color-surface-raised': 'oklch(100% 0 0)',
      '--color-surface-hover': 'oklch(96.7% 0.001 286.375)',
      '--color-surface-pressed': 'oklch(93.5% 0.003 286.375)',
      '--color-surface-selected': 'oklch(95% 0.002 286.375)',
      '--color-surface-sunken': 'oklch(96.7% 0.001 286.375)',
    },
  },
  {
    ...
    tokens: {
      ...
      '--color-text': 'oklch(21% 0.006 285.885)',
      // 运行态观测值 55.2% 在浅灰画布上仅 4.35:1；略降亮度以守住正文 AA。
      '--color-text-muted': 'oklch(54% 0.016 285.938)',
      '--color-text-disabled': 'oklch(70.5% 0.015 286.067)',
    },
  },
  {
    title: '边界(subtle/border/strong 三级)',
    tokens: {
      '--color-border-subtle': 'oklch(94.5% 0.003 286.32)',
      '--color-border': 'oklch(94.5% 0.003 286.32)',
      '--color-border-strong': 'oklch(92% 0.004 286.32)',
    },
  },
  {
    ...
    tokens: {
      ...
      '--color-accent-hover': 'oklch(27.4% 0.006 286.033)',
      '--color-accent-pressed': 'oklch(14.1% 0.005 285.823)',
      '--color-accent-soft': 'oklch(93.5% 0.003 286.375)',
      '--color-accent-contrast': 'oklch(98.5% 0 0)',
    },
  },
  {
    ...
    tokens: {
      ...
      '--color-primary-contrast': 'oklch(98.5% 0 0)',
      '--color-primary-bg': 'oklch(93.5% 0.003 286.375)',
    },
  },
  {
  ...
  },
  {
    title: '焦点环',
    tokens: {
      '--color-focus-ring': 'oklch(55% 0.16 255)',
    },
  },
  {
  ...
  },
  {
    ...
    tokens: {
      ...
      '--content-public-flow': '384px',
      '--content-settings': '704px',
  ...
  },
  {
    ...
    tokens: {
      ...
      '--font-size-public-flow-title': '1.5rem',
  ...
  },
  {
    ...
    tokens: {
      ...
      '--line-height-title-1': '1.5rem',
      '--line-height-title-2': '1.5rem',
      '--line-height-title-3': '1.25rem',
      '--line-height-public-flow-title': '2rem',
  ...
  },
  {
    ...
    tokens: {
      ...
      '--font-family-display':
        "'Inter', system-ui, -apple-system, 'Segoe UI', 'Noto Sans SC', 'PingFang SC', 'Hiragino Sans GB', 'Microsoft YaHei', sans-serif",
      '--font-family-mono':
  ...
  },
  {
    ...
    tokens: {
      ...
      '--shadow-3': '0 16px 40px rgba(15, 23, 42, 0.14), 0 3px 10px rgba(15, 23, 42, 0.08)',
      '--shadow-raised': '0 1px 2px rgba(15, 23, 42, 0.04), 0 1px 1px rgba(15, 23, 42, 0.03)',
    },
  },
  {
    title:
...
export const DARK_TOKENS: Readonly<Record<string, string>> = Object.freeze({
  ...
  '--color-surface-subtle': 'oklch(27.4% 0.006 286.033)',
  '--color-surface-raised': 'oklch(23.5% 0.007 285.885)',
  '--color-surface-hover': 'oklch(27.4% 0.006 286.033)',
  '--color-surface-pressed': 'oklch(30% 0.006 286.033)',
  '--color-surface-selected': 'oklch(30% 0.006 286.033)',
  '--color-surface-sunken': 'oklch(18% 0.005 285.823)',
  '--color-text-strong': 'oklch(98.5% 0 0)',
  '--color-text': 'oklch(92% 0.004 286.32)',
  '--color-text-muted': 'oklch(70.5% 0.015 286.067)',
  '--color-text-disabled': 'oklch(55.2% 0.016 285.938)',
  '--color-border-subtle': 'oklch(100% 0 0 / 0.06)',
  '--color-border': 'oklch(100% 0 0 / 0.06)',
  '--color-border-strong': 'oklch(100% 0 0 / 0.15)',
  '--color-accent': 'oklch(92% 0.004 286.32)',
  '--color-accent-hover': 'oklch(98.5% 0 0)',
  '--color-accent-pressed': 'oklch(70.5% 0.015 286.067)',
  '--color-accent-soft': 'oklch(27.4% 0.006 286.033)',
  '--color-accent-contrast': 'oklch(21% 0.006 285.885)',
  '--color-primary': 'oklch(92% 0.004 286.32)',
  '--color-primary-contrast': 'oklch(21% 0.006 285.885)',
  '--color-primary-bg': 'oklch(27.4% 0.006 286.033)',
  ...
  '--color-focus-ring': 'oklch(65% 0.16 255)',
  '--color-scrim': 'rgba(0, 0, 0, 0.72)',
  // 暗色阴影加深;组件在暗色下另以 border 补层级(§5.4:不能只靠黑色阴影)。
  '--shadow-1': '0 1px 2px rgba(0, 0, 0, 0.2), 0 1px 1px rgba(0, 0, 0, 0.16)',
  '--shadow-2': '0 8px 24px rgba(0, 0, 0, 0.32), 0 2px 6px rgba(0, 0, 0, 0.2)',
  '--shadow-3': '0 20px 48px rgba(0, 0, 0, 0.46), 0 4px 12px rgba(0, 0, 0, 0.28)',
  '--shadow-raised': '0 1px 2px rgba(0, 0, 0, 0.2), 0 1px 1px rgba(0, 0, 0, 0.16)',
});
...
export const AA_CONTRAST_PAIRS: ReadonlyArray<ContrastPair> = [
  ...
  { fg: '--color-focus-ring', bg: '--color-canvas', kind: 'graphic' },
