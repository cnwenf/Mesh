 ...
 *   /settings            → Navigate replace → /settings/profile
 *   /settings/profile    → 昵称 + 头像资料
...
export function SettingsPage(): React.JSX.Element {
  ...
  return (
    <div className="mesh-settings-page">
      <SettingsLayout title={t('settings.title')} groups={groups} navLabel={t('settings.navLabel')}>
        <Outlet />
      </SettingsLayout>
    </div>
  );
