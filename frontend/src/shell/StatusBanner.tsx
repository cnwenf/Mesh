 ...
 *
 * - offline 与 reconnecting 均呈现「网络已断开」横幅(掉线后 WS 转入 reconnecting,
 *   用户仍须看到离线横幅,§6.12)—— 二者共用 `status-banner-offline` testid;
 * - resyncing 呈现「正在重新同步…」横幅,对账成功后由 AppShell 状态回 connected 而无感消失;
