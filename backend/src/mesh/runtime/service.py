...
_DIAGNOSTIC_REPAIR_COMMANDS = {
    ...
    "provider_isolation_failed": "mesh-runtime doctor --config <config-file>",
    "runtime_auth_failed": "mesh-runtime doctor --config <config-file>",
    "sandbox_security_failed": "mesh-runtime doctor --config <config-file>",
    "security_anomaly": "mesh-runtime doctor --config <config-file>",
    "usage_invariant_failed": "mesh-runtime doctor --config <config-file>",
