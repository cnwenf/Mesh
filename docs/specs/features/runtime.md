...
| trigger | text | NOT NULL DEFAULT `'assign'`, CHECK IN (`'assign'`,`'mention'`,`'autopilot'`,`'manual'`,`'chat'`,`'integration'`) | `'assign'` | 触发方式(R2:`'integration'` = 外部 IM/VCS 集成触发,README §6.9/§6.17、integrations.md) |
